                ...
                <div className="tiny-slide" key={index}>
                  <div className="group text-center m-2">
                    <div className="relative overflow-hidden rounded-full">
                      <img
                        src={item.image}
                        className="w-full md:h-32 h-36 object-cover scale-125 group-hover:scale-100 duration-500 shadow dark:shadow-gray-800"
                        alt=""
                      />
                    </div>
                    ...
                    <div className="mt-2">
                      ...
                      <p className="text-slate-400 text-sm duration-500">
                        {item.hotels}
                      </p>
                    </div>
                  </div>
